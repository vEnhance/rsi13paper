...
\begin{comment}
\include{aliasctr.sty}
\include{asymptote.sty}
\include{gettitlestring.sty}
\include{parseargs.sty}
\include{thm-amsthm.sty}
\include{thm-autoref.sty}
\include{thm-beamer.sty}
\include{thmdef-mdframed.sty}
\include{thmdef-shaded.sty}
\include{thmdef-thmbox.sty}
\include{thm-kv.sty}
\include{thm-listof.sty}
\include{thm-llncs.sty}
\include{thm-ntheorem.sty}
\include{thm-patch.sty}
\include{thm-restate.sty}
\include{thmtools.sty}
\include{unique.sty}
\include{main-1.pdf}
\include{main-2.pdf}
\include{main-3.pdf}
